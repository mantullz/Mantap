...
wget https://raw.githubusercontent.com/fisabiliyusri/Mantap/main/ssh/slhost.sh && chmod +x slhost.sh && ./slhost.sh
#install xray
wget https://raw.githubusercontent.com/fisabiliyusri/Mantap/main/xray/ins-xray.sh && chmod +x ins-xray.sh && screen -S xray ./ins-xray.sh
#install ssh ovpn
wget https://raw.githubusercontent.com/fisabiliyusri/Mantap/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh-vpn ./ssh-vpn.sh
wget https://raw.githubusercontent.com/fisabiliyusri/Mantap/main/sstp/sstp.sh && chmod +x sstp.sh && screen -S sstp ./sstp.sh
#install ssr
wget https://raw.githubusercontent.com/fisabiliyusri/Mantap/main/ssr/ssr.sh && chmod +x ssr.sh && screen -S ssr ./ssr.sh
...
#installwg
wget https://raw.githubusercontent.com/fisabiliyusri/Mantap/main/wireguard/wg.sh && chmod +x wg.sh && screen -S wg ./wg.sh
#install L2TP
wget https://raw.githubusercontent.com/fisabiliyusri/Mantap/main/ipsec/ipsec.sh && chmod +x ipsec.sh && screen -S ipsec ./ipsec.sh
wget https://raw.githubusercontent.com/fisabiliyusri/Mantap/main/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
# Websocket
wget https://raw.githubusercontent.com/fisabiliyusri/Mantap/main/websocket/edu.sh && chmod +x edu.sh && ./edu.sh
# Ohp Server
